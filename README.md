...
[Everything you need to know to start coding your own shell](https://savanna.alxafrica.com/concepts/64)

[Approaching a Project](https://savanna.alxafrica.com/concepts/350)

## Background Context
Write a simple UNIX command interpreter.

![The Gate of Shell](./images/The_Gate_Of_Shell.jpeg)

^ “The Gates of Shell”, by [Spencer Cheng](https://x.com/spencerhcheng/status/855104635069054977), featuring [Julien Barbier](https://twitter.com/julienbarbier42)
...
The reality is that at this point of the program, if you have not cheated before, you have everything you need to complete the project with what you have learned + the page “Everything you need to know to start coding your own shell” [/concepts/64](https://savanna.alxafrica.com/concepts/64)
...
So you are supposed to work TOGETHER. And you should both understand every single line of code that any of you pushes. Here is a link for you to read about pair programming: [/concepts/121](https://savanna.alxafrica.com/concepts/121)
...
- Your code should use the [Betty style](https://github.com/alx-tools/Betty/blob/master/betty-style.pl). It will be checked using [betty-style.pl](https://github.com/alx-tools/Betty/blob/master/betty-doc.pl) and betty-doc.pl
...
* Write your own getl`ine function
